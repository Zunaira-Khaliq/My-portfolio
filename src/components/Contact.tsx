...
const Contact = () => {
  return (
    <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
        <div className='flex justify-center items-center'>
            <ul className='space-y-4'>
                <li className='flex items-center'>
                    <Image src={phone} alt='phone' className='h-[110px] w-auto mr-6' priority/>
                    <p className='text-xl'>+92 335 2408761</p>
                </li>
                <li className='flex items-center'>
                    <Image src={mail} alt='mail' className='h-[110px] w-auto mr-6' priority/>
                    <p className='text-xl'>zunairakhaliq24@gmail.com</p>
                </li>
            </ul>
        </div>
        ...
        <p className='text-white/70 mb-6 '>Send me a message and lets schedue a call!</p>
        <form className='space-y-4' action="https://getform.io/f/agddpzvb" method='POST'>
