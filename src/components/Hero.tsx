...
import profilepicmasha from "../assets/profilepicmasha.png";

const Hero = () => {
  return (
<div className="py-20 mt-4 relative overflow-clip bg-[linear-gradient(to_bottom,#000,#2B1942_35%,#8F5C55_60%,#DBAF6E_80%)]">
    ...
    <div className="absolute rounded-[50%] w-[3000px] h-[1300px] top-[550px] left-[50%] -translate-x-1/2
        ...
        <div className="relative">
            <div className="text-8xl font-bold text-center">
                ...
                <h1 className="text-[#E48A57]">Zunaira</h1>
            </div>

            <motion.div 
                className="hidden md:block absolute left-[260px] top-[170px]"
                drag
            >
                <Image
                src={cursor}
